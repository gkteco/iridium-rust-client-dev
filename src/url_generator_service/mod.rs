pub mod UrlGeneratorService {
    ...
    pub fn getIridiumAuthUrl(state: &str, code_challenge: &str) -> String {
        dotenv().ok();
        ...
        format!("{}login?response_type=code&state={}&redirect_uri={}&client_id={}&code_challenge_method=S256&code_challenge={}", base_url, state, redirectUri, clientId, code_challenge)
    }
}
